...
public class MailSenderService implements IMailSenderService {
	...
	/**
	 * Versendet Mail an einen Empfï¿½nger
	 */
	...
	/**
	 * Sendet Mail an eine Liste von Empfï¿½ngern
	 */
	...
	/**
	 * Auï¿½erhalb der Server Umgebung, falls Inject nicht funktioniert
	 */
	...
	private void sendeNachricht(List<MimeMessage> nachrichten, Session session) {
		...
		try {
			...
			MailSenderService.LOGGER.log(Level.INFO, "Verbindung zu Mailserver geï¿½ffnet.");
