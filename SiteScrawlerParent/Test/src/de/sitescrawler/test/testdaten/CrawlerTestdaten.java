...
public class CrawlerTestdaten
{
    public static String       spiegel_WieGelaehmt_ArtikelUrl_WieGelaehmt = "http://www.spiegel.de/sport/fussball/dfb-pokal-borussia-moenchengladbach-wirkte-wie-gelaehmt-gegen-frankfurt-a-1144859.html#ref=rss";
    public static List<String> spiegel_WieGelaehmt_Absaetze               = new ArrayList<>();
    static
    {
        // Artikel Spiegel: Wie Gelähmt Absätze einfügen
        CrawlerTestdaten.spiegel_WieGelaehmt_Absaetze.add(
        ...
        CrawlerTestdaten.spiegel_WieGelaehmt_Absaetze.add("Im Video: Dieter Hecking über das Gladbach-Aus");
        CrawlerTestdaten.spiegel_WieGelaehmt_Absaetze.add("\"Das ist die Tragik im Fußball\"");
        CrawlerTestdaten.spiegel_WieGelaehmt_Absaetze.add(
