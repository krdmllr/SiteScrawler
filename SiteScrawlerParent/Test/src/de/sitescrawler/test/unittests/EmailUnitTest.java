...
public class EmailUnitTest
{
    ...
    // ByteArrayDataSource data2 = new ByteArrayDataSource(data, "String");
    //
    // IMailSenderService mail = new MailSenderService();
    // try
    // {
    // mail.sendeMail(emailAdresse, subjekt, body, htmlBody, data2);
    // }
    ...
    // try
    // {
    // mail.sendeMail(emailAdressen, subjekt, body, htmlBody, data2);
    // }
    // catch (ServiceUnavailableException e)
    // {
    // Assert.fail();
